package com.pseudonova.employme.utils.items;
...
public class GlowEffect
{
	...
	public static void deleteGlow(ItemStack item)
	{
		...
		ItemMeta im = item.getItemMeta(); //No need to check for the ItemMeta's existence because enchantments(The useless one in this context) lay inside the ItemMeta
